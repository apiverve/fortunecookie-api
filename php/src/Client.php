...
namespace APIVerve\Fortunecookie;
...
/**
 * Client for the Fortune Cookie Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/fortunecookie?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/fortunecookie';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FortunecookieClient] {$message}\n";
        }
    }
}
