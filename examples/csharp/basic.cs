...
{
    class FortuneCookieGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/fortunecookie";

        /// <summary>
        /// Make a GET request to the Fortune Cookie Generator API
        /// </summary>
        static async Task<JsonDocument> CallFortuneCookieGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; 3, [&quot;type&quot;] &#x3D; &quot;wisdom&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Fortune Cookie Generator API...\n");

            var result = await CallFortuneCookieGeneratorAPI();
