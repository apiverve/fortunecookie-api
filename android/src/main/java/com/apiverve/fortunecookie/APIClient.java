package com.apiverve.fortunecookie;
...
/**
 * Main API client for Fortune Cookie Generator
 * Provides a simple interface to access the APIVerve Fortune Cookie Generator
 */
