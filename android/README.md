# Fortune Cookie Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:fortunecookie-api:1.1.12'
}
```
...
```java
import com.apiverve.fortunecookie.FortuneCookieGeneratorAPIClient;
import com.apiverve.fortunecookie.APIResponse;
import com.apiverve.fortunecookie.APIException;

// Initialize the client
FortuneCookieGeneratorAPIClient client = new FortuneCookieGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/fortunecookie](https://docs.apiverve.com/ref/fortunecookie)
...
- **Documentation:** [https://docs.apiverve.com/ref/fortunecookie](https://docs.apiverve.com/ref/fortunecookie)
- **Issues:** [GitHub Issues](https://github.com/apiverve/fortunecookie-api/issues)
