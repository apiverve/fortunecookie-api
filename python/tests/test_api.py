...
class TestFortunecookieAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = FortunecookieAPIClient(self.api_key)

    @patch('apiverve_fortunecookiegenerator.apiClient.requests.get')
